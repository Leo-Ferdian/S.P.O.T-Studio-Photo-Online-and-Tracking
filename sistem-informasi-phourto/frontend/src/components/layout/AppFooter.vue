    ...
    <footer class="bg-white text-text-default p-8">
        <div class="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-start lg:items-center">
            ...
            <div class="lg:col-span-6 grid grid-cols-2 sm:grid-cols-4 gap-4 font-display text-sm w-full">
                ...
                <div>
                    <h4 class="font-bold mb-3 text-base">Any Problem?</h4>
                    <ul class="space-y-1.5 text-gray-700">
                        <li><router-link to="/ContactUs" class="hover:text-primary">Contact Admin</router-link></li>
                    </ul>
                </div>
            </div>

            <div class="lg:col-span-3 flex justify-start lg:justify-end space-x-4">
                <a href="#"
                    class="bg-black text-cream p-2 rounded-full border-2 border-black hover:bg-gray-800 transition-colors">
                    <i data-feather="voicemail" class="w-5 h-5"></i>
                </a>
                <a href="#"
                    class="bg-black text-cream p-2 rounded-full border-2 border-black hover:bg-gray-800 transition-colors">
