    ...
    <div class="bg-background min-h-screen flex items-center justify-center text-text-default">
        <div class="max-w-lg w-full p-8 space-y-6">
            ...
            <router-link to="/" class="relative inline-block text-5xl font-bold mx-auto mb-8 block text-center">
                ...
                <span class="absolute top-0 right-0 text-[10px] leading-none font-sans font-bold w-20 text-right">
                ...
                <div>
                    ...
                    <div class="relative mt-1">
                        <input v-model="password" :type="isPasswordVisible ? 'text' : 'password'" id="password" required
                            class="w-full p-3 bg-primary text-text-inverse border-3 border-outline shadow-solid 
                        placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 
                        focus:ring-offset-background focus:ring-primary transition-all" />
            ...
            hover:bg-gray-200 active:shadow-none active:translate-x-1 active:translate-y-1 
        ...
        <!-- Footer Bawah -->
        <div class="absolute bottom-0 left-0 right-0 bg-primary text-text-default font-bold p-4 
            border-t-3 border-outline text-center">
            Don't have an account?
            <router-link to="/register" class="hover:underline text-background">Register</router-link>
        </div>
    </div>
</template>
